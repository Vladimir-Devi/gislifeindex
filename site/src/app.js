const BLOCKS = [
  {
    ...
    label: "Жилье",
    color: "#256d72",
    help: "Субиндекс Жилья. Отражает обеспеченность жильем и степень износа многоквартирных домов."
  },
  {
    key: "infra",
    label: "Инфраструктура",
    color: "#6f6c2d",
    help: "Субиндекс социальной и повседневной инфраструктуры. Отражает доступность объектов, их функциональное разнообразие и полноту ежедневной корзины."
  },
  {
    key: "transport",
    label: "Транспорт",
...
const INDICATOR_META = {
  ...
  "Жилье|износ": {
    unit: "%",
    help: "Средневзвешенный износ многоквартирного жилищного фонда."
  },
  "Жильё|износ": {
    unit: "%",
    help: "Средневзвешенный износ многоквартирного жилищного фонда."
  ...
  "Жилье|этажность": {
    unit: "этажей",
    help: "Средняя этажность многоквартирной жилой застройки квартала."
  },
  "Жильё|этажность": {
    unit: "этажей",
    help: "Средняя этажность многоквартирной жилой застройки квартала."
  ...
  "Инфраструктура|полнота корзины": {
    unit: "%",
    help: "Доля базовой повседневной корзины услуг и объектов, доступной жителям квартала."
  },
  "Транспорт|доступность": {
    unit: "%",
    help: "Доля населения квартала в зоне доступности остановок общественного транспорта."
  },
  "Рабочие места|обеспеченность": {
    unit: "коэф.",
    help: "Коэффициент обеспеченности квартала рабочими местами."
  },
  ...
  "Зеленые зоны|доступность": {
    unit: "%",
    help: "Доля жителей квартала в зоне доступности зеленых зон."
  },
  "Коммерция|активность ФНС": {
    unit: "0-10",
    help: "Оценка коммерческой активности по данным ФНС."
  },
  "Коммерция|ККТ": {
    unit: "ед.",
    help: "Число контрольно-кассовой техники."
  },
  "Коммерция|медианный чек": {
    unit: "руб.",
    help: "Медианного чек коммерческих операций."
  }
};
