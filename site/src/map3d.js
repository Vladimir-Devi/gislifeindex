...
const INDICATOR_META = {
  ...
  "Зелёные зоны|покрытие квартала зеленью": { unit: "%", help: "Доля площади квартала, покрытая зелёной растительностью по Sentinel" },
  "Зелёные зоны|температура поверхности": { unit: "°C", help: "Средняя температура поверхности квартала по Landsat" },
